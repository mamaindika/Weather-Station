...
$places = $book->getElementsByTagName( "place" );
...
$query = sprintf("SELECT temp,DateAndTime,place FROM weatherData,WeatherStations  WHERE  DateAndTime between DATE(".$todate.") AND DATE(".$fromdate.") AND place ='".$place."' AND lon = longitude AND lat=latitude ORDER BY  DateAndTime");
