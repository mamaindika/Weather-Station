  ...
  <div class="row" style="height:100%;width:100%;margin:0px;">
    ...
    <div class="col-sm-12" id="pages_about" style="height:95%;padding:0px;"> 
        <div class="" style="height:100%;background-color:#c2c2a3;padding:3px;">
            ...
            <h1 style="height:5%;"><center><b>WIND DIRECTION MAP</b></center></h1>
        </div>
     </div>
    ...
    var infoWindow = new google.maps.InfoWindow;
      ...
      downloadUrl('setXML.php', function(data) {
        ...
        Array.prototype.forEach.call(markers, function(markerElem) {
          ...
          if(WndDir==1){
            textWndDir.textContent = 'Wind Direction = North'
          }
          else if(WndDir==2){
            textWndDir.textContent = 'Wind Direction = South'
          }
          else if(WndDir==3){
            textWndDir.textContent = 'Wind Direction = East'
          }
          else if(WndDir==4){
            textWndDir.textContent = 'Wind Direction = West'
          }
          else if(WndDir==5){
            textWndDir.textContent = 'Wind Direction = North-West'
          }
          else if(WndDir==6){
            textWndDir.textContent = 'Wind Direction = North-East'
          }
          else if(WndDir==7){
            textWndDir.textContent = 'Wind Direction = South-West'
          }
          else if(WndDir==8){
            textWndDir.textContent = 'Wind Direction = South-East'
          }
          ...
          var image = {
            url: 'images/windDirection.png', // url
