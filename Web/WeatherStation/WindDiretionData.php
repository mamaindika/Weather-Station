...
$query = sprintf("SELECT WndDir,DateAndTime FROM weatherData  WHERE DateAndTime >= DATE(".$todate.") AND DateAndTime <= DATE(".$fromdate.")ORDER BY  DateAndTime");
//execute query
