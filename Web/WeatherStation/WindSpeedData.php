...
$query = sprintf("SELECT WndSpeed,DateAndTime FROM weatherData  WHERE DateAndTime between DATE(".$todate.") AND DATE(".$fromdate.")ORDER BY  DateAndTime");
//execute query
